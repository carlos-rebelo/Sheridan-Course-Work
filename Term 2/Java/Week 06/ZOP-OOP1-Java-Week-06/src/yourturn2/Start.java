...
public class Start {
    public static void main(String[] args)
    {
        ...
        MovieTicket[] movieTickets = {
            new MovieTicket("Black Panther",TicketType.ADULT, 1),
            new MovieTicket("John Wick 4", TicketType.CHILD, 2),
            new MovieTicket("The Revenant", TicketType.SENIOR, 3)

        };

        for(MovieTicket ticket: movieTickets) {
            System.out.println("Movie Name: "+ticket.getMovieName()+" Cost: "+ ticket.getType().getPrice());
        }
