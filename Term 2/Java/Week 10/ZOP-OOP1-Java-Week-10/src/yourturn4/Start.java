...
public class Start {
    public static void main (String[] args) throws Exception
    {
        ...
        //Create a class called ObjectSafe that uses a Generic to allow the calling method to store any object in the safe, along with a password.  Write a constructor that will accept an object of the Generic type, and an int password used to retrieve this object.
        ...
        //When you've written your code correctly, this code should work!

        ObjectSafe<String> ob1 = new ObjectSafe<>("Yay!", 123);
