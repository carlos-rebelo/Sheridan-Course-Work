...
public class PartD {
    public static void main(String[] args)
    {
        ...
        while (r4.getAvenue() < 10)
        {
            while (r4.canPickThing())
            {
                r4.pickThing();
            }
            r4.move();
        ...
        while (r4.countThingsInBackpack() != 0)
        {
            r4.putThing();
            r4.move();
        }
    ...
    public static void navigateAroundWall(Robot robot)
    {
        robot.turnLeft();
        robot.move();
        turnRight(robot);
