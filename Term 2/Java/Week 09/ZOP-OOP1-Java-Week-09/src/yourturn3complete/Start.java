...
public class Start {
    public static void main(String[] args)
    {
        ...
        MainframeComputer actualMainframeComputer = new MainframeComputer();
        actualMainframeComputer.accessBasicFunctionality();
        actualMainframeComputer.accessUpgradedFunctionality();
        ...
        BasicMainframe basicMainframe = actualMainframeComputer;
        basicMainframe.accessBasicFunctionality();
        ...
        UpgradedMainframe upgradedMainframe = actualMainframeComputer;
        upgradedMainframe.accessUpgradedFunctionality();
        ...
        //PS - Elon Musk uses the golden screwdriver with his Tesla cars.  A Tesla can go so many km before needing a recharge but the customer can pay extra and a software upgrade (golden screwdriver) will unlock extra kms per charge.  https://futurism.com/tesla-boosted-the-range-of-cars-in-hurricane-irmas-path
