...
public class Start {
    public static void main(String[] args)
    {
        ...
        *create a class called SuperRobot that extends robot and:
         * 
         * 1. has a turnRight() method - prove that it works with our r1 robot
         * 2. has a method called move that accepts an int and will move forward as many spaces as the int passed in- prove that it works with our r2 robot
