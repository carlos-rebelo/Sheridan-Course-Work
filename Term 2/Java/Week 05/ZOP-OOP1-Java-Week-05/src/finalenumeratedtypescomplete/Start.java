...
public class Start {
    ...
    {
        int num1 = 100; //what if we make num1 final?
        num1 = 50;
        ...
        //what if someone set our pizza size to 14?  We could test for it and throw an exception, OR we could prevent them from making that mistake
